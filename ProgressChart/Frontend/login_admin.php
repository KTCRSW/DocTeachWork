...
<body>
  ...
  text-white rounded-none rounded-l-[15px] bg-[#3884fd]  w-32 hover:bg-[#5ED9AC]"><img src="./image/graduated (1).png" class="mr-1">นักเรียน</button>
          ...
          /*                                    login                                   */
          /* -------------------------------------------------------------------------- */ -->
                    <form action="../demo/admin/auth.php" method="post" name="frm">
                        <div class="flex justify-center items-center mt-8">
                            <div class="w-[340px]">
                                <div class="relative h-10 w-full min-w-[200px]  ">

                                    <input id="idcard" type="text" class="peer h-full w-full rounded-[7px] border border-gray-300 t bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50" placeholder=" " name="username"/>
